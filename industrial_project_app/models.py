...
class Institute(models.Model):
    ...
    email=models.OneToOneField(User_table,on_delete=models.CASCADE,blank=True,null=True)
...
class Like(models.Model):
    User = models.ForeignKey(User_info,None,blank=True,null=True)
    Post=models.ForeignKey(post,None,blank=True,null=True)
    LikeCount = models.IntegerField(default=0)



class UnLike(models.Model):
    User = models.ForeignKey(User_info,None,blank=True)
...
class Comment(models.Model):
    ...
    User = models.ForeignKey(User,None,blank=True)
    Post = models.ForeignKey(post,None,blank=True)
    CreatedDate = models.DateTimeField(auto_now_add=True)
    UpdateDate= models.DateTimeField(auto_now_add=True)
...
class Followers_User(models.Model):
    User = models.OneToOneField(User_info,related_name='Followers',on_delete=models.CASCADE)
